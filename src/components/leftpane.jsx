    ...
    return(
        <div className="sticky top-0 flex flex-col w-[250px] h-screen p-4 bg-[#FFF] border-[#AAA1] border-r-2 justify-between">
            <div className="font-['Helvetica'] flex flex-col gap-2">
                <div className="font-bold text-xl flex gap-2 bg-black rounded-md p-3 text-white">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                </svg>
                Notes
                </div>
                <div className="flex gap-2 p-2 bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                    </svg>
                    <p className="overflow-hidden text-ellipsis my-auto text-sm" title="manoj.paramsetti@gmail.com">manoj.paramsetti@gmail.com</p>
                </div>
            ...
            <button className="px-4 py-2 flex gap-2 bg-red-100 hover:bg-red-500 rounded-full text-red-600 hover:text-red-100">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
